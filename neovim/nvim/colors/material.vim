...
let g:material_colorscheme_map.cyan = s:purple " s:cyan
let g:material_colorscheme_map.blue = s:orange  " s:blue
...
let g:material_colorscheme_map.violet = s:green  " s:violet
